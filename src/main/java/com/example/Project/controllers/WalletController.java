...
public class WalletController {
    ...
    public void deleteWallet(@PathVariable("wallet_id") String wallet_id){
...
//        Customer deletedCustomer = customer.delete();
    ...
    public Wallet AddPaymentMethod(@RequestBody Wallet w,
        ...
        Customer customer = Customer.retrieve(w.getWallet_id(), retrieveParams, null);
        ...
        System.out.println("card brand : " + card.getBrand());
